...
15-19: Subtropical: Forest, plains, scrub, and deserts
...
If no ocean list are empty the lists will spread out from cool.  If a swamp list is emply it will spread out from warm.  If a special islands list is empty it will use normal islands instead; that is, it will mainland biomes.
