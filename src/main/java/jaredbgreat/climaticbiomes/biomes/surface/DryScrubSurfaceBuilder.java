...
public class DryScrubSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

    public DryScrubSurfaceBuilder(Function<Dynamic<?>, ? extends SurfaceBuilderConfig> p_i51305_1_) {
        super(p_i51305_1_);
    }
