...
import jaredbgreat.climaticbiome.blocks.EnumWoodType;
...
public class BlockPineSlab extends BlockSlab {
    ...
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state) {
        return new ItemStack(this, 1, ((EnumWoodType)state.getValue(TYPE)).getMetadata());
    }
    ...
    protected static boolean isHalfSlab(IBlockState state) {
        return state.getBlock() == ModBlocks.pineHalfSlab;
    }
